...
| `creatinine`       | `number`         | Serum creatinine  **mg/dL**. Elevated values indicate organ dysfunction. |
| `altered_mentation`| `boolean`        | True if GCS < 15 (altered mental status, qSOFA criterion).                |
